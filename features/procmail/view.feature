...
Then the menu "Procmail" should be active
...
Then I should see links "Forward, Procmail, Translations" within the "navigation" section
When I go to the procmail filters page
And I follow "<link>"
...
| Procmail     | procmail filters |
| Translations | translations     |

Scenario Outline: Links on the Procmail Index Page for user
Given I am logged in as "test"
Then I should see links "Forward, Procmail" within the "navigation" section
When I go to the procmail filters page
And I follow "<link>"
Then I should be on the <section> page
Examples:
